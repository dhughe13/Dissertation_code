...
library('sjPlot')
# Now get the data
d0 = read_excel("~/Documents/MATLAB/Graph_theory/Dissertation_code/Chapter4_LongitudinalDifferences/Mixed_effects_modeling/str_w_longitudinal_df.xlsx", na="NaN") 
# check the dimension
dim(d0)
...
ggplot(d2, aes(x=factor(Age2b), y=y2, group=Group, colour=Group)) +
  ...
  xlab("Change in Age") +
  ylab("Structural Strength, PFCoi_L") +
  ggtitle("Structural Strength, PFCoi_L vs. Change in Age")

ggsave("w_str_longitudinal_PFCoiL.png",path="~/Documents/MATLAB/Graph_theory/Dissertation_code/Chapter4_LongitudinalDifferences/Plotting_in_R/")
```
