...
library('sjPlot')
# Now get the data
d0 = read_excel("~/Documents/MATLAB/Graph_theory/Dissertation_code/Chapter4_LongitudinalDifferences/Mixed_effects_modeling/deg_fc_longitudinal_df.xlsx", na="NaN") 
# check the dimension
dim(d0)
...
ggplot(d2, aes(x=factor(Age2b), y=y2, group=Group, colour=Group)) +
  ...
  xlab("Change in Age") +
  ylab("Functional Degree, PFCoi_L") +
  ggtitle("Functional Degree, TCs_R vs. Change in Age")

ggsave("fc_deg_longitudinal_TCsR.png",path="~/Documents/MATLAB/Graph_theory/Dissertation_code/Chapter4_LongitudinalDifferences/Plotting_in_R/")
```
