---
title: "Longitudinal Differences Plotting Notebook"
...
library('sjPlot')
# Now get the data
d0 = read_excel("~/Documents/MATLAB/Graph_theory/Dissertation_code/Chapter4_LongitudinalDifferences/Mixed_effects_modeling/cc_w_longitudinal_df.xlsx", na="NaN") 
# check the dimension
dim(d0)
...
ggplot(d2, aes(x=factor(Age2b), y=y2, group=Group, colour=Group)) +
  ...
  xlab("Change in Age") +
  ylab("Structural CC, S2_L") +
  ggtitle("Structural Clustering Coefficient, S2_L vs. Change in Age")

ggsave("w_cc_longitudinal_S2L.png",path="~/Documents/MATLAB/Graph_theory/Dissertation_code/Chapter4_LongitudinalDifferences/Plotting_in_R/")
```

```{r}
ggplot(d2, aes(x=factor(Age2b), y=y3, group=Group, colour=Group)) +
  geom_smooth(method="lm", linewidth=3) +
  scale_color_manual(values = c("#EE6677","#4477AA")) +
  xlab("Change in Age") +
  ylab("Structural CC, TM-T_L") +
  ggtitle("Structural Clustering Coefficient, TM-T_L vs. Change in Age")

ggsave("w_cc_longitudinal_TMTL.png",path="~/Documents/MATLAB/Graph_theory/Dissertation_code/Chapter4_LongitudinalDifferences/Plotting_in_R/")
```
